    ...
    <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
            ...
            <div class="relative flex h-16 items-center justify-between">
                <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                    ...
                    <DisclosureButton
                        ...
                        <font-awesome-icon v-if="!open" icon="bars" class="block size-6" />
                        <font-awesome-icon v-else icon="xmark" class="block size-6" />
                    </DisclosureButton>
                </div>
        ...
        <DisclosurePanel class="sm:hidden">
            <div class="space-y-1 px-2 pt-2 pb-3">
                <RouterLink v-for="item in navigation" :to="item.to">
...
const navigation = [
    { name: 'Home', to: '/', current: route.name == 'Home' },
    { name: 'About Us', to: '/about', current: route.name == 'About' },
]
</script>
